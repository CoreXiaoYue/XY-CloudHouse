			...
			<div class="row">
				<div class="col-md-1 col-xs-12 bg-success" >
					...
					<div class="col-md-11 col-xs-12">
						<div class="row">
							<div class="col-md-12">
								<form class="form-inline" action="selectByquery" method="post">
										<div class="form-group ">
											<label for="exampleInputName2">姓名：</label>
											<input type="text" class="form-control" id="exampleInputName2" placeholder="按姓名查找" name="name">
										</div>
										<div class="form-group ">
											<label for="exampleInputEmail2">专业：</label>
											<input type="text" class="form-control" id="exampleInputEmail2" placeholder="按院系查找" name="department">
										</div>
										<div class="form-group ">
											<label for="exampleInputEmail2">院系：</label>
											<input type="text" class="form-control " id="exampleInputEmail2" placeholder="按专业查找" name="professional">
										</div>
									...
									<table class="table table-bordered" style="width: 100%;">
										...
										<c:forEach items="${requestScope.list}" var="student">
											<tr>
												<td>${student.name}</td>
												<td>
													<fmt:formatDate value="${student.admission}" type="date" />
												</td>
