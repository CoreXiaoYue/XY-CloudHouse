...
//    @Insert("select * from student")
    ...
    @Select("SELECT id,name,gender,department,admission,professional FROM student name LIKE #{student.name} or department like #{student.department} or professional like #{student.professional}")
